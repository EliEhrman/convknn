...
v_sdb = tf.Variable(tf.zeros([c_num_convs*c_num_files_per_batch, c_target_dim], dtype=tf.float32), name='v_sdb')
op_sdb_set = tf.assign(v_sdb, tf.nn.l2_normalize(tf.matmul(v_db_norm, W), dim=1), name='op_sdb_set')
